...
interface HardLimits {
    companion object {
        ...
        val LIMIT_MIN_BG = doubleArrayOf(50.0, 180.0)
        val LIMIT_MAX_BG = doubleArrayOf(50.0, 200.0)
        val LIMIT_TARGET_BG = doubleArrayOf(50.0, 200.0)

        // Very Hard Limits Ranges for Temp Targets
        val LIMIT_TEMP_MIN_BG = doubleArrayOf(50.0, 180.0)
        val LIMIT_TEMP_MAX_BG = doubleArrayOf(50.0, 270.0)
        val LIMIT_TEMP_TARGET_BG = doubleArrayOf(50.0, 200.0)
